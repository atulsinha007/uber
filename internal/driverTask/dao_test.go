...
// TODO: complete all these by adding dummy data
func (suite *DaoTestSuite) Test_AcceptRideRequest() {

}

func (suite *DaoTestSuite) Test_UpdateRide() {

}

func (suite *DaoTestSuite) Test_GetFromDriverIdAndCustomerTaskId() {

}

func (suite *DaoTestSuite) Test_FindNearestDriver() {

}

func (suite *DaoTestSuite) Test_CreateDriverTask() {
